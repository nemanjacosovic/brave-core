...
void BatAdsClientMojoBridge::IsParticipatingSiteForPublisherAds(
    const std::string& url,
  ...
  bat_ads_client_->IsParticipatingSiteForPublisherAds(url,
      base::BindOnce(&OnIsParticipatingSiteForPublisherAds,
          std::move(callback)));
}
